...
# ========================= Learning Configs ==========================
parser.add_argument('--epochs', default=1100, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument('--training_epoch_multiplier', '--tem', default=1, type=int,
...
parser.add_argument('--lr_steps', default=[1100, 2000, 2000], type=float, nargs="+",
                    metavar='LRSteps', help='epochs to decay learning rate by 10')
parser.add_argument('--momentum', default=0.9, type=float, metavar='M',
                    help='momentum')
parser.add_argument('--weight-decay', '--wd', default=8e-4, type=float,
...
parser.add_argument('--test-print-freq', '-pt', default=2, type=int,
                    metavar='N', help='print frequency (default: 20)')
parser.add_argument('--eval-freq', '-ef', default=5, type=int,
                    metavar='N', help='evaluation frequency (default: 4)')
...
parser.add_argument('--gpus', nargs=1, type=int, default=None)
